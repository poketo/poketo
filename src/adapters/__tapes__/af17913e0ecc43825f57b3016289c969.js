...
module.exports = function (req, res) {
  ...
  res.setHeader("date", "Mon, 13 Aug 2018 03:33:12 GMT");
  res.setHeader("content-type", "application/json");
  res.setHeader("transfer-encoding", "chunked");
  res.setHeader("connection", "close");
  res.setHeader("set-cookie", ["__cfduid=ddf6b5b54741b92322cf70351f708f8a41534131192; expires=Tue, 13-Aug-19 03:33:12 GMT; path=/; domain=.mangadex.org; HttpOnly","PHPSESSID=a34bej6tair0luvk9mtifvfibc; path=/; domain=.mangadex.org"]);
  res.setHeader("expires", "Thu, 19 Nov 1981 08:52:00 GMT");
  res.setHeader("cache-control", "no-store, no-cache, must-revalidate");
  res.setHeader("pragma", "no-cache");
  res.setHeader("expect-ct", "max-age=604800, report-uri=\"https://report-uri.cloudflare.com/cdn-cgi/beacon/expect-ct\"");
  res.setHeader("server", "cloudflare");
  res.setHeader("cf-ray", "44981e6ea85793ba-SJC");
