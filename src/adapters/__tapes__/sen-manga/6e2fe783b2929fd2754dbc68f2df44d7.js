...
module.exports = function (req, res) {
  ...
  res.setHeader("date", "Fri, 17 Aug 2018 01:19:54 GMT");
  res.setHeader("content-type", "text/html; charset=UTF-8");
  res.setHeader("transfer-encoding", "chunked");
  res.setHeader("connection", "close");
  res.setHeader("set-cookie", ["__cfduid=d2d3194cde96812a7ffb4ce8d499424b11534468793; expires=Sat, 17-Aug-19 01:19:53 GMT; path=/; domain=.senmanga.com; HttpOnly; Secure","PHPSESSID=rft1ad233uujiu2b0ma8fbnda5; path=/; domain=raw.senmanga.com; secure; HttpOnly"]);
  ...
  res.setHeader("cf-ray", "44b850a78b2393d2-SJC");
