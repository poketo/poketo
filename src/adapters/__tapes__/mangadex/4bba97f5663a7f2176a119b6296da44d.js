...
module.exports = function (req, res) {
  ...
  res.setHeader("set-cookie", ["__cfduid=d7b628504dc29418322795103312982f41534133118; expires=Tue, 13-Aug-19 04:05:18 GMT; path=/; domain=.mangadex.org; HttpOnly","PHPSESSID=8v44ggr2aph9kfhpsv0euc6r3v; path=/; domain=.mangadex.org"]);
  res.setHeader("expires", "Thu, 19 Nov 1981 08:52:00 GMT");
  res.setHeader("cache-control", "no-store, no-cache, must-revalidate");
  res.setHeader("pragma", "no-cache");
  res.setHeader("expect-ct", "max-age=604800, report-uri=\"https://report-uri.cloudflare.com/cdn-cgi/beacon/expect-ct\"");
  res.setHeader("server", "cloudflare");
  res.setHeader("cf-ray", "44984d75ece09384-SJC");
